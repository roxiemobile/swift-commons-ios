// ----------------------------------------------------------------------------
//
//  SwiftCommons.Core.Extensions-Bridging-Header.h
//
...
#import "SwiftCommons.Core.Abstractions-Bridging-Header.h"
#import "SwiftCommons.Core.Logging-Bridging-Header.h"
