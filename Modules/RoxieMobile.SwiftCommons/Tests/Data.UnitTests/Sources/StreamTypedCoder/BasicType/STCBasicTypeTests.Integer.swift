...
//            XCTAssertEqual(_uIValue, _uIResult)
    ...
    func testUnsignedIntegers_TSC() {
        ...
        assertNoThrow {
            ...
            // Decode
            var _uI8Result: UInt8?
            if let value = TypedStreamDecoder(forReadingFrom: mdata as Data, failurePolicy: policy).decodeObject() as? UInt8 {
                _uI8Result = value
            }
            XCTAssertEqual(_uI8Value, _uI8Result)
        }
        ...
        assertNoThrow {
            ...
            // Decode
            var _uI16Result: UInt16?
            if let value = TypedStreamDecoder(forReadingFrom: mdata as Data, failurePolicy: policy).decodeObject() as? UInt16 {
                _uI16Result = value
            }
            XCTAssertEqual(_uI16Value, _uI16Result)
        }
        ...
        assertNoThrow {
            ...
            // Decode
            var _uI32Result: UInt32?
            if let value = TypedStreamDecoder(forReadingFrom: mdata as Data, failurePolicy: policy).decodeObject() as? UInt32 {
                _uI32Result = value
            }
            XCTAssertEqual(_uI32Value, _uI32Result)
        }
        ...
        assertNoThrow {
            ...
            // Decode
            var _uI64Result: UInt64?
            if let value = TypedStreamDecoder(forReadingFrom: mdata as Data, failurePolicy: policy).decodeObject() as? UInt64 {
                _uI64Result = value
            }
            XCTAssertEqual(_uI64Value, _uI64Result)
        }
        ...
        assertNoThrow {
            ...
            // Decode
            var _uIResult: UInt?
            if let value = TypedStreamDecoder(forReadingFrom: mdata as Data, failurePolicy: policy).decodeObject() as? UInt {
                _uIResult = value
            }
            XCTAssertEqual(_uIValue, _uIResult)
        }
...
//            XCTAssertEqual(_iValue, _iResult)
    ...
    func testSignedIntegers_TSC() {
        ...
        assertNoThrow {
            ...
            // Decode
            var _i8Result: Int8?
            if let value = TypedStreamDecoder(forReadingFrom: mdata as Data, failurePolicy: policy).decodeObject() as? Int8 {
                _i8Result = value
            }
            XCTAssertEqual(_i8Value, _i8Result)
        }
        ...
        assertNoThrow {
            ...
            // Decode
            var _i16Result: Int16?
            if let value = TypedStreamDecoder(forReadingFrom: mdata as Data, failurePolicy: policy).decodeObject() as? Int16 {
                _i16Result = value
            }
            XCTAssertEqual(_i16Value, _i16Result)
        }
        ...
        assertNoThrow {
            ...
            // Decode
            var _i32Result: Int32?
            if let value = TypedStreamDecoder(forReadingFrom: mdata as Data, failurePolicy: policy).decodeObject() as? Int32 {
                _i32Result = value
            }
            XCTAssertEqual(_i32Value, _i32Result)
        }
        ...
        assertNoThrow {
            ...
            // Decode
            var _i64Result: Int64?
            if let value = TypedStreamDecoder(forReadingFrom: mdata as Data, failurePolicy: policy).decodeObject() as? Int64 {
                _i64Result = value
            }
            XCTAssertEqual(_i64Value, _i64Result)
        }
        ...
        assertNoThrow {
            ...
            // Decode
            var _iResult: Int?
            if let value = TypedStreamDecoder(forReadingFrom: mdata as Data, failurePolicy: policy).decodeObject() as? Int {
                _iResult = value
            }
            XCTAssertEqual(_iValue, _iResult)
        }
