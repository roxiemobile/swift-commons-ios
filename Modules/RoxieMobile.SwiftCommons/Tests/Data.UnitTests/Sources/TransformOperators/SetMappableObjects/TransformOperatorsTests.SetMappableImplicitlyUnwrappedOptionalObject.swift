// ----------------------------------------------------------------------------
//
//  TransformOperatorsTests.SetMappableImplicitlyUnwrappedOptionalObject.swift
//
...
extension TransformOperatorsTests
{
    ...
    func testSetMappableImplicitlyUnwrappedOptionalObjectToJSON() {
    ...
    func testSetMappableImplicitlyUnwrappedOptionalObjectFromJSON() {
