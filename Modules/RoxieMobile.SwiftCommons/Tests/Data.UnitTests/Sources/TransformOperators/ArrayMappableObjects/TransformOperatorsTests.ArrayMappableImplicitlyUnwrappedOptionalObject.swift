// ----------------------------------------------------------------------------
//
//  TransformOperatorsTests.ArrayMappableImplicitlyUnwrappedOptionalObject.swift
//
...
extension TransformOperatorsTests
{
    ...
    func testArrayMappableImplicitlyUnwrappedOptionalObjectToJSON() {
    ...
    func testArrayMappableImplicitlyUnwrappedOptionalObjectFromJSON() {
