// ----------------------------------------------------------------------------
//
//  TransformOperatorsTests.ArrayImplicitlyUnwrappedOptionalBasicTypeObject.swift
//
...
extension TransformOperatorsTests
{
    ...
    func testArrayImplicitlyUnwrappedOptionalBasicTypesObjectToJSON() {
    ...
    func testArrayImplicitlyUnwrappedOptionalBasicTypesObjectFromJSON() {
