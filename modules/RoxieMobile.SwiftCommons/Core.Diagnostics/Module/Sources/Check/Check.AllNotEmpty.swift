...
//    public static func isAllNotEmpty(_ values: [String]?, _ message: @autoclosure () -> String = "", _ file: StaticString = #file, _ line: UInt = #line) throws {
...
//         -  values: An array of string objects.
//     */
//    public static func allNotEmpty(_ values: [String]?, _ message: @autoclosure () -> String = "", _ file: StaticString = #file, _ line: UInt = #line) throws {
//        if CollectionUtils.isNotEmpty(values) {
//            try isTrue(StringUtils.isAllNotEmpty(values), message, file, line)
//        }
//    }
