...
// --
    ...
    public static func isNotEmpty<T>(array: [T]?) -> Bool {
        return !isEmpty(array)
    }

    /// Checks if given Set is non {@code nil} and has elements.
    public static func isNotEmpty<T>(set: Set<T>?) -> Bool {
        return !isEmpty(set)
    }

    /// Checks if given Dictionary is non {@code nil} and has elements.
    public static func isNotEmpty<K, V>(map: Dictionary<K, V>?) -> Bool {
        return !isEmpty(map)
    }
